...
{
    public class DeviceManagerException : Exception
    {
        ...
        public DeviceManagerException(string format, params object[] args)
            : base(string.Format(format, args))
        {
        }

        public DeviceManagerException(Exception innerException, string message)
